...
def reduceH5file(data_path, DCOtype, optimistic, BPSmodelName):
    ...
    # path for files 
    path_ = data_path + alphabetDirDict[BPSmodelName] +'/'
    pathToNewData  = path_ + 'COMPASCompactOutput_'+ DCOtype +'_' + BPSmodelName + '_wform.h5'
    ...
    for ind_zz in range(len(Data.PerSystemPerRedshift_ratesIntrinsic)):
            ...
            Rdetxyz.attrs[u"units"] = u"Gpc^{-3}yr^{-1}"   
 # = fdata.create_group("weights_intrinsicFormationPerRedshift")
 #            formationPerSystem_zz = Data.PerSystemPerRedshift_formationIntrinsic[ind_zz,:] * Data.COMPAS.weight  #//floor z_form          
    ...
    temp_ = RintPerRedshift.create_dataset(u"SEED", data=seedsDCO)
    temp_.attrs[u"units"] = u"#"
